        ...
        <Nav className="mr-auto">
          ...
          {user && user.token ? (
            <>
              ...
              <Link to="/books/add" component={NavLink}>Add Books</Link>
              {/* <Link to="/booksProfile" component={NavLink}>Books Profile</Link> */}
              {/* <Link to="/booksProfile/edit" component={NavLink}>Edit Books Profile</Link> */}
